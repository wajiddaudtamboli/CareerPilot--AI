      ...
      <div className="min-h-screen flex items-center justify-center bg-white px-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-gray-700 mb-6">
            Authentication isn’t configured. Set <span className="font-mono">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</span> to enable Clerk.
          </p>
          <Link
            href="/"
            className="inline-block px-5 py-2 rounded-md bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors"
          >
            Go to Home
          </Link>
        </div>
