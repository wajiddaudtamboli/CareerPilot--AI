...
import CodeEditor from "../../components/Ediotor";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          {/* <div className="bg-white p-6 rounded-lg shadow-lg">
            <textarea
              ...
              className=" w-full h-64 p-4 font-mono text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="Write your code here..."
              disabled={!isTimerRunning} // Disable the textarea if timer is not running
            />
            <Button
              onClick={() => submitAnswer(currentQuestionIndex)}
